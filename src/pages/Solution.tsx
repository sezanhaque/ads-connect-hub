      ...
      <main className="container mx-auto px-4 py-12 md:py-20">
        ...
        <section className="text-center max-w-4xl mx-auto mb-20 md:mb-28">
          ...
          <p className="text-lg md:text-xl text-muted-foreground font-now leading-relaxed mb-8 max-w-3xl mx-auto">
            ...
            in fragmented ad ecosystems. Our mission is to bring transparency, control, 
            and simplicity to digital advertising.
          </p>
        ...
        <section className="max-w-4xl mx-auto mb-20 md:mb-28">
          <h2 className="text-2xl md:text-3xl font-now font-bold text-foreground mb-8 text-center">
            Our Vision
          </h2>
          <div className="space-y-6 text-muted-foreground font-now">
        ...
        {/* How It Works Today */}
        <section className="max-w-4xl mx-auto mb-20 md:mb-28">
          <h2 className="text-2xl md:text-3xl font-now font-bold text-foreground mb-10 text-center">
            How It Works Today
          </h2>
        ...
        <section className="max-w-4xl mx-auto mb-20 md:mb-28">
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-4 p-5 bg-card border rounded-xl">
              <CheckCircle className="h-6 w-6 text-success flex-shrink-0 mt-0.5" />
              <div>
                <h3 className="font-now font-semibold text-foreground mb-1">Full transparency on costs and performance</h3>
                <p className="text-sm text-muted-foreground font-now">
                  See exactly where every euro goes and what results it generates. No hidden metrics or unclear reports.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-4 p-5 bg-card border rounded-xl">
              <CheckCircle className="h-6 w-6 text-success flex-shrink-0 mt-0.5" />
              <div>
                <h3 className="font-now font-semibold text-foreground mb-1">No hidden fees or media markups</h3>
                <p className="text-sm text-muted-foreground font-now">
                  Your budget goes to advertising, not intermediary costs. What you see is what you pay.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-4 p-5 bg-card border rounded-xl">
              <CheckCircle className="h-6 w-6 text-success flex-shrink-0 mt-0.5" />
              <div>
                <h3 className="font-now font-semibold text-foreground mb-1">Scalable setup for ongoing hiring needs</h3>
                <p className="text-sm text-muted-foreground font-now">
                  Whether you're filling five roles or fifty, the platform grows with your needs without added complexity.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="max-w-4xl mx-auto mb-20 md:mb-28">
          ...
          <div className="bg-muted/30 border rounded-xl p-8 md:p-10 text-center">
            <p className="text-muted-foreground font-now leading-relaxed mb-4">
            ...
            <p className="text-foreground font-now font-medium">
        ...
        <section className="max-w-2xl mx-auto text-center mb-16">
          <div className="bg-card border rounded-xl p-8 md:p-12">
            ...
            <h2 className="text-2xl md:text-3xl font-now font-bold text-foreground mb-4">
              Working in a different niche?
            </h2>
            <p className="text-muted-foreground font-now mb-8">
              If you're operating outside recruitment but the vision resonates, we'd like to hear from you. 
              Let's explore if this platform fits your needs.
            </p>
