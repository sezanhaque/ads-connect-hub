  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-muted/30 section-padding">
        <div className="container mx-auto px-4">
          <motion.div className="text-center mb-10 md:mb-14 space-y-3" {...fadeUp}>
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-now font-bold text-foreground">Two platforms. One campaign.</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6 max-w-4xl mx-auto">
            {/* Facebook */}
            <motion.div className="unified-card space-y-4 !p-6 md:!p-8" {...fadeUp}>
            ...
            {/* Instagram */}
            <motion.div className="unified-card space-y-4 !p-6 md:!p-8" {...fadeUp} transition={{ duration: 0.5, delay: 0.1 }}>
              <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-[#F58529]/10 via-[#DD2A7B]/10 to-[#8134AF]/10 flex items-center justify-center">
