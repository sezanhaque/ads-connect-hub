      ...
      <section className="container mx-auto px-4 pt-12 md:pt-20 pb-16 md:pb-20">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <motion.div className="space-y-6" {...fadeUp}>
            ...
            <p className="text-lg md:text-xl text-muted-foreground font-now leading-relaxed max-w-xl">Turn your vacancies into targeted Facebook & Instagram campaigns that deliver a steady flow of new applicants.</p>
            <p className="text-lg md:text-xl text-muted-foreground font-now leading-relaxed max-w-xl">No marketing expertise needed. No agency required.</p>
