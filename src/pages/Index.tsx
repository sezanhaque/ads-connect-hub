  ...
  return <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
      ...
      <main className="container mx-auto px-4 py-20">
        <div className="text-center space-y-8 max-w-3xl mx-auto">
          <h1 className="font-now font-bold tracking-tight bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent leading-[1.2] text-5xl text-center whitespace-nowrap">Recruitment Advertising Seen Clearly</h1>
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-20">
            <div className="text-center space-y-4">
              ...
              <h3 className="text-lg font-now font-semibold whitespace-nowrap">Hire faster, work smarter</h3>
            ...
            <div className="text-center space-y-4">
              ...
              <h3 className="text-lg font-now font-semibold whitespace-nowrap">Campaigns built in minutes</h3>
            ...
            <div className="text-center space-y-4">
              ...
              <h3 className="text-lg font-now font-semibold whitespace-nowrap">Full clarity on data and costs</h3>
