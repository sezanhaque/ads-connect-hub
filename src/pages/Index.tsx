                    ...
                    <ul className="w-[240px] p-2">
                      <li>
                        <NavigationMenuLink asChild>
                          <Link to="/platform-overview" className="block select-none rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground">
