...
export const SignupConfirmationEmail = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>Welcome to AdsConnect - Confirm your email to get started</Preview>
      <Body style={main}>
        <Container style={container}>
          <Heading style={h1}>⚡ AdsConnect</Heading>
          <Heading style={h2}>Welcome to AdsConnect!</Heading>
          ...
          <Section style={section}>
            ...
            <Text style={text}>
              ...
              Please confirm your email address to get started with AdsConnect.
            </Text>
          ...
          <Text style={footer}>
            If you didn't create an account with AdsConnect, you can safely ignore this email.
          </Text>
        </Container>
      </Body>
    </Html>
